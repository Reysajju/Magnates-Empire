<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "sajjjad.rasool@gmail.com";
...
<html lang="en">
		<head>
				<meta charset="utf-8">
				<title>Sales Inquery | MagnatesEmpire.com</title>
									...
									<div class="vMiddle">
										...
										<div class="row d-md-flex text-center justify-content-center text-primary action-icons">
											<div class="col-sm-4">
												...
												<p class="lead"><a href="tel:+[Your Phone]">+92 314 283 4340</a></p>
											</div>
											<div class="col-sm-4">
												<p><em class="ion-ios-chatbubble-outline icon-md"></em></p>
												<p class="lead"><a href="mailto:hello@example.com">sajjjad.rasool@gmail.com</a></p>
											</div>
									</div>
								</div>
							</div>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														<h1 class="pt-4 h2"><span class="text-green">Sajjad Rasool</span></h1>
														<span class="text-muted">Karachi, PK</span>
														<p><span>Web Strategist, Front-end Developer & UX/ UI Designer</span></p>
														<br/>
														<a target="_blank" rel="nofollow" href="https://sajjad.escritura.site">sajjad.escritura.site</a>
													</div>
											</div>
									</section>
							</div>
